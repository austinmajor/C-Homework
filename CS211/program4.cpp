...
WSUID: N675Q967
HW#: 4
Description: Functions and Vending Machines
*/
...
//Output menu and validate input
...
//Output accepted types of change and input for payment
...
//Compute the amount of changed owed

int computeChange(int totalPaid, int totalPrice) {
	return (totalPaid - totalPrice);
}

//Dispenses the least amount of coins as change
...
void dispenseChange(int change) {
	...
	//Creates array of keys cooresponding to accepted types and stores change
